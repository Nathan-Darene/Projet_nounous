...
!(function () {
    ...
    function X(e) {
        ...
        if ("touchstart" === a.type)
            return void R(t, a, a.targetTouches[0].pageX);
            ...
            breakpoints: {
                setBreakpoint: function () {
                    ...
                    const h = l.direction && l.direction !== i.direction,
                        f =
                            i.loop &&
                            (l.slidesPerView !== i.slidesPerView || h),
                        g = i.loop;
    ...
    const he = [
        function (e) {
            ...
            function p(e, t) {
                ...
                if (t && !l && o > 0) return;
                const { addSlidesBefore: p, addSlidesAfter: c } =
                        s.params.virtual,
                    {
                        from: u,
                        to: m,
                ...
                (b = s.rtlTranslate
                    ...
                    : "top"),
                    r
                        ? ((y = Math.floor(i / 2) + a + c),
                          (x = Math.floor(i / 2) + a + p))
                        : ((y = i + (a - 1) + c), (x = (l ? i : a) + p));
                let E = w - x,
                    S = w + y;

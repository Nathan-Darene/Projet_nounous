...
<head>
    ...
    <title>Social Home: Déconnexion</title>
    <link rel="stylesheet" href="{{ asset('fontawesome-free-6.5.1-web/css/all.min.css') }}">
    <link rel="stylesheet" href="{{ asset('css/connexion.css') }}">
    <!--link rel="stylesheet" href="http://maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css"-->
    <link rel="icon" type="image/png"
        href="{{ asset('Logo/8900808870_4aa536ff-86f5-4f1e-9429-0e0ace5a8068.png') }}">
</head>
        ...
        <div class="main-card-login">
            <div class="login-card">
                ...
                <form action="{{ route('login-user') }}" method="POST" class="login-card-form">
                    ...
                    @if ($data ?? '')
                        <div class="img-case">
                            ...
                            <span class="nom"><i
                                    class="fa-solid fa-user-xmark"></i>&nbsp{{ $data['username'] }}</span>
                ...
                <div class="login-card-footer">
                    <p>Vous n'avez pas de compte ? <a href="/registration" class="link">Inscrivez-vous </a><i
                            class="fa-solid fa-face-smile-beam"></i></p>
                </div>
